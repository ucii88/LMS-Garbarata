                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div class="relative bg-[#eef3f8] rounded-xl overflow-hidden aspect-[16/10] border border-[#dce4ec] flex items-center justify-center shadow-inner">
                            ...
                            @if($diagram && $diagram->image_path && file_exists(public_path($diagram->image_path)))
                                <img src="{{ asset($diagram->image_path) }}" class="w-full h-full object-cover select-none" alt="Diagram Garbarata">
                            @else
                        ...
                        <template x-if="activeModuleId !== null">
                            <div class="flex flex-col h-full flex-1">
                                ...
                                <div class="p-6 bg-gray-50/50 border-b border-gray-100">
                                    <span class="text-xs text-blue-600 font-bold uppercase tracking-wider">Detail Komponen</span>
                                    <h3 class="text-lg font-bold text-gray-900 mt-1" x-text="getActiveModule().title"></h3>
                                </div>

                                <!-- Konten Modul -->
                                <div class="p-6 flex-1 overflow-y-auto prose max-w-none text-sm text-gray-600 leading-relaxed space-y-4" x-html="getActiveModule().content">
                                </div>
