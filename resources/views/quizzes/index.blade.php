...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    @if($quizzes->isEmpty())
        <div class="bg-white border border-dashed border-slate-200 rounded-2xl p-12 text-center">
            ...
            <p class="text-base text-slate-500 mt-1">Buat {{ $isPractice ? 'latihan' : 'quiz' }} pertama untuk course ini.</p>
        </div>
    @else
        <div class="space-y-3">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-0.5">
                            ...
                            @if(!$quiz->is_active)
                                <span class="text-sm px-2 py-0.5 bg-slate-100 text-slate-500 rounded-full">Non-aktif</span>
                            @endif
                        </div>
