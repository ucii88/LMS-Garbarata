<aside x-cloak x-show="!$store.ui.sidebarCollapsed" x-transition class="w-64 bg-white border-r border-[#f0f0f0] flex flex-col justify-between h-screen sticky top-0 shrink-0 select-none">
    ...
    <div class="py-6 px-5 space-y-7">
        ...
        <div class="flex items-center justify-between px-2">
            ...
            <div class="w-7 h-7 rounded-lg bg-gradient-to-tr from-[#0091ff] to-[#40a9ff] flex items-center justify-center text-white shadow-sm font-black text-base tracking-tighter">
        ...
        <nav class="space-y-1">
            @if(Auth::user()->isAdmin())
                ...
                <a
                    ...
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('dashboard') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
            ...
            @if(Auth::user()->isInstruktur())
                ...
                <a
                    ...
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('courses.show') || request()->routeIs('courses.chapters.*') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
                ...
                <a
                    ...
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('practices.*') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
                ...
                <a
                    ...
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('quizzes.*') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
            ...
            @if(Auth::user()->isPeserta())
                ...
                <a
                    href="{{ route('courses.show', 1) }}"
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('courses.show') || request()->routeIs('courses.chapters.show') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
                 ...
                 <a
                    ...
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('courses.practices') || request()->routeIs('practice.*') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
                ...
                <a
                    ...
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 {{ request()->routeIs('courses.quizzes') || request()->routeIs('quiz.*') ? 'bg-[#e6f4ff] text-[#0091ff]' : 'text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800' }}"
                >
                ...
                @if($userCert)
                    <a
                        ...
                        class="flex items-center space-x-3 px-3.5 py-2.5 rounded-lg text-base font-semibold transition-all duration-150 text-gray-500 hover:bg-[#f5f5f5] hover:text-gray-800"
                    >
