    ...
    public function run(): void
    {
        ...
        Module::create([
            ...
            'content' => '<p>Pemeliharaan drive column dan kaki penopang (wheel boogie) sangat krusial untuk kestabilan serta keamanan pergerakan naik-turun maupun maju-mundur Garbarata.</p>' .
                ...
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.3.2 Bantalan Lift Column</h4>' .
                '<p>Bantalan <em>oil-impregnated nylon-molybdenum</em> berfungsi sebagai column guides dan mencegah logam dan logam bersentuhan. Setiap lift column memiliki 8 bantalan, 4 di atas dan 4 lainnya di bawah. Seseorang harus memeriksa daya tahan bantalan tersebut setahun sekali.</p>' .
                ...
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.3.3 Inspeksi Ball Screw</h4>' .
                '<p>Lift column ball-screw harus dilumasi and diperiksa setelah 5 tahun sejak diservis dari korosi yang berlebihan, keretakan, lubang, cekung/lekuk, atau pemakaian yang tidak biasa dari ball grooves. Setelah pemeriksaan yang pertama ball screw harus diperiksa setiap 5 tahun.</p>' .
                ...
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.3.4 Kekencangan Lift Column</h4>' .
                '<p>Periksalah baut-baut yang terpasang pada lift column dan wheel boogie setelah setahun beroperasi dan kencangkan baut-baut tersebut pada kekencangan yang dianjurkan seperti yang disebutkan pada <a href="#torque-diagram" class="text-blue-600 hover:underline font-bold">gambar Recommended Fastener Torque</a> yang terlampir di bawah.</p>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.3.5 Rantai Boogie Drive</h4>' .
                '<p>Rantai-rantai ini meskipun dirakit dengan benar dari pabrik, tetap harus diperiksa kembali secara teratur. Ganti bagian rantai yang renggang, retak atau kejanggalan yang lain.</p>' .
                ...
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.3.6 Rem Cyclo Drive Motor</h4>' .
                '<p>Rem pada horizontal dan vertical cycle drive bekerja secara elektro mekanik dan pemeriksaan yang teratur dan service akan memastikan performa yang baik. Rem harus diperiksa setelah beroperasi satu tahun. Untuk memeriksa baik rem vertical atau horizontal drive, kru maintenance memerlukan dongkrak.</p>' .
                ...
                '</div>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.3.7 Ban</h4>' .
                '<p class="font-bold text-slate-700 text-xs mb-2">CARA MELEPASKAN BAN</p>' .
        ...
        Module::create([
            ...
            'content' => '<p>Pelajari seluruh penjabaran dibawah ini sebelum mencoba menyesuaikan Roller. Hal ini dapat membuat Roller tahan lama dan mencegah kerusakan yang fatal.</p>' .
                ...
                '</div>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.4.2 Pengaturan Vertikal Roller</h4>' .
                '<p>Perpanjangan dan lurusnya posisi garbarata untuk melepas bobot pada roller LF karena LF adalah vertical, tidak perlu diatur, thrust roller, ini menjadi awal yang baik untuk memulai.</p>' .
                ...
                '</div>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.4.3 Pengaturan Horizontal Roller</h4>' .
                '<ul class="list-none space-y-3 mt-2 text-xs text-slate-600">' .
                '<li>' .
                '<strong>(a) Panjangkan dan luruskan garbarata serta hilangkan semua access cover:</strong>' .
                '<ul class="list-disc list-inside ml-4 mt-1 space-y-1">' .
                '<li>(i) Mengukur dari dalam tunnel B, tentukan bagaimana roller LR dan LF menyesuaikan untuk memperoleh jarak yang sama diantara E dan F.</li>' .
                ...
                '</li>' .
                '<li>' .
                '<strong>(c)</strong> Pendekkan garbarata perlahan untuk mengalihkan beban pada roller LR dan UF. Lepas jam nuts dan mundurkan roller UR yang cukup untuk melakukan pengaturan roller LR. Dimensi G dan H harus sama.' .
                '</li>' .
                '</ul>' .
                ...
                '<li>' .
                '<strong>(d) Panjangkan perlahan garbarata untuk memindahkan bobot roller UR dan LF:</strong>' .
                '<ul class="list-disc list-inside ml-4 mt-1 space-y-1">' .
                '<li>(i) Lepaskan jam nuts pada roller LR dan LT.</li>' .
                '<li>(ii) Putarlah bolt pengaturan pada roller LR dan LT pada arah tunnel yang bergerak untuk membuat jarak G ke H, dan E ke F sama. Lihat bagian A-A dan C-C pada figure tunnel cross section.</li>' .
                '<li>(iii) Kencangkan side bolt yang berlawanan pada roller LR dan LT untuk mengatasi celah dari penyetelan di item atas.</li>' .
                ...
                '<ul class="list-disc list-inside ml-4 mt-1 space-y-1">' .
                '<li>(i) Pendekkan garbarata untuk mengalihkan bobot pada roller UR dan UF.</li>' .
                '<li>(ii) Kencangkan roller UR-R hingga bertumpu pada rel dengan baik dan kencangkan jam nut. Lihat sesi A-A pada fitur TCS (Tunnel Cross Section).</li>' .
        ...
        Module::create([
            ...
            'content' => '<p>Ada dua macam perbedaan pada bahan Frayed Closure:</p>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-4 mb-2">Lubang berdiameter kurang dari atau sama dengan 3 mm</h4>' .
                ...
                '</ul>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-4 mb-2">Lubang berdiameter lebih dari 3 mm</h4>' .
                ...
                '</ul>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.5.1. Closure Limit Switches</h4>' .
                '<p class="text-xs text-slate-600 mb-2">Untuk mengatur limit switch, ikuti langkah-langkah berikut:</p>' .
                '<ul class="list-none space-y-1.5 text-xs text-slate-600">' .
        ...
        Module::create([
            'chapter_id' => $chapter->id,
            'title' => '4.6 Checklist Inspeksi dan Prosedur',
            'content' => '<p>Pelajari panduan inspeksi rutin dan spesifikasi pelumasan di bawah ini untuk menjaga kondisi operasional jembatan Garbarata.</p>' .
                ...
                '</ul>' .
                '</div>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.6.2 Pelumasan</h4>' .
                '<ul class="list-none space-y-3 text-xs text-slate-600">' .
                '<li>' .
                ...
                '<div class="font-bold text-slate-800 uppercase tracking-wide">UNITED</div>' .
                '<div class="font-bold text-slate-800 uppercase tracking-wide text-[10px] mb-2">GREASE INDUSTRY</div>' .
                '<div class="text-[10px] text-slate-500 font-semibold italic">atau</div>' .
                '<div class="text-[10px] text-slate-500 font-semibold italic">sejenisnya</div>' .
                '</td>' .
                '</tr>' .
                '<tr class="bg-slate-50/30">' .
                '<td class="p-2 border border-gray-200 text-center font-semibold"># 2</td>' .
                '<td class="p-2 border border-gray-200 text-left">UG-765 KABEL DAN PELUMAS RANTAI atau sejenisnya.</td>' .
                '</tr>' .
                '<tr>' .
                '<td class="p-2 border border-gray-200 text-center font-semibold"># 3</td>' .
                '<td class="p-2 border border-gray-200 text-left">UG-747 Multifungsi atau pelumas jenis ringan seperti LOTUS 888.</td>' .
                '</tr>' .
                '</tbody>' .
                '</table>' .
                '</div>' .
                ...
                '<ul class="list-decimal list-inside space-y-1.5 mt-1">' .
                '<li>Garbarata memerlukan indeks kental tinggi, stabilitas oksidasi tinggi, peminyakan yang baik, kekuatan minyak film, anti-foaming, sifat anti korosi.</li>' .
                '<li>Kekentalan pelumas yang memudahkan cyclo drive menyala harus lebih rendah dari 4300 CST pada temperatur yang dianjurkan; jika pelumasan dengan bantuan alat digunakan, seperti menggunakan pompa plunger atau pompa trochoid, Viskositas tidak boleh melebihi 2000 CST untuk mempertahankan lapisan pelumasan yang memadai.</li>' .
                '</ul>' .
                '</div>' .
                '<div class="space-y-6 mt-6 max-w-md mx-auto">' .
                '<div class="rounded-xl border border-gray-200 bg-gray-50 p-3 shadow-sm flex flex-col items-center">' .
                '<p class="text-[10px] font-bold text-slate-500 text-center mb-2">AIRCRAFT INTERFACE DIAGRAM</p>' .
                '<img src="/images/modules/enhanced_aircraft_diagram.png" class="w-full max-h-72 object-contain rounded-lg select-none" alt="Aircraft Interface Diagram">' .
                '</div>' .
                '<div class="rounded-xl border border-gray-200 bg-gray-50 p-3 shadow-sm flex flex-col items-center">' .
                '<p class="text-[10px] font-bold text-slate-500 text-center mb-2">VERTICAL LIFT COLUMN</p>' .
                '<img src="/images/modules/enhanced_vertical_lift_column.png" class="w-full max-h-72 object-contain rounded-lg select-none" alt="Vertical Lift Column Diagram">' .
                '</div>' .
                '<div class="rounded-xl border border-gray-200 bg-gray-50 p-3 shadow-sm flex flex-col items-center">' .
                '<p class="text-[10px] font-bold text-slate-500 text-center mb-2">WHEEL BOOGIE ASSEMBLY</p>' .
                '<img src="/images/modules/enhanced_wheel_boogie_assembly.png" class="w-full max-h-72 object-contain rounded-lg select-none" alt="Wheel Boogie Assembly">' .
                '</div>' .
                '<div class="rounded-xl border border-gray-200 bg-gray-50 p-3 shadow-sm flex flex-col items-center">' .
                '<p class="text-[10px] font-bold text-slate-500 text-center mb-2">CABIN ROTATION SYSTEM</p>' .
                '<img src="/images/modules/enhanced_cabin_rotation.png" class="w-full max-h-72 object-contain rounded-lg select-none" alt="Cabin Rotation System">' .
                '</div>' .
                '<div class="rounded-xl border border-gray-200 bg-gray-50 p-3 shadow-sm flex flex-col items-center">' .
                '<p class="text-[10px] font-bold text-slate-500 text-center mb-2">ROTUNDA ASSEMBLY</p>' .
                '<img src="/images/modules/rotunda_hd.png" class="w-full max-h-72 object-contain rounded-lg select-none" alt="Rotunda Assembly">' .
                '</div>' .
                '</div>' .
                '<h4 class="font-bold text-slate-800 text-xs mt-6 mb-2">4.6.3 Inspeksi Bulanan</h4>' .
                ...
                '<div class="overflow-x-auto my-4">' .
                '<p class="text-[10px] font-bold text-slate-500 mb-1.5 uppercase">Tabel Inspeksi Bulanan (Bagian 1: Operasional & Sensor)</p>' .
                '<table class="min-w-full divide-y divide-gray-200 border border-gray-100 text-xs">' .
                ...
                '<tbody class="divide-y divide-gray-100 text-slate-600">' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">AUTO LEVEL</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-blue-50/50 text-blue-800 text-[11px] border border-gray-200"><strong>CATATAN:</strong> Timer Auto Level diatur oleh Internal Counter Program melalui Programmable Logic Controller.</td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">ELEKTRIKAL</td></tr>' .
                '<tr><td colspan="2" class="p-2 text-slate-500 font-semibold italic border border-gray-200 bg-slate-50/30">Periksa Control Console operator, Power Panel dan Main Panel listrik:</td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>1.</strong> Semua PCB, Jaringan Kabel dan Susunan Listrik dari sambungan yang kemungkinan longgar. Bersihkan area yang sering terjadi kontak dengan pembersih kontak.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>2.</strong> Periksa kelembaban, karat dan serpihan-serpihan.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>3.</strong> Periksa semua tanda lengkungan atau sambungan yang longgar.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">LIMIT SWITCH</td></tr>' .
                '<tr><td colspan="2" class="p-2 text-slate-500 font-semibold italic border border-gray-200 bg-slate-50/30">Putar ke posisi manual pada Keyswitch, operasikan Garbarata untuk memeriksa Limit Switch berikut ini agar dapat dipastikan semua berfungsi dengan baik:</td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>1.</strong> Limit Switch arah horizontal; maju dan mundur penuh.</td><td class="p-2 border border-gray-200"></td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-blue-50/50 text-blue-800 text-[11px] border border-gray-200"><strong>CATATAN:</strong><br>a. Periksa hanya satu Limit Switch dalam satu waktu.<br>b. Semua gerakan harus dilakukan perlahan jika pengoperasian terasa kasar dan berisik, periksa gangguan di atas Roller Tracks.</td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">PERIKSA BAN</td></tr>' .
                ...
                '<p class="text-[10px] font-bold text-slate-500 mb-1.5 uppercase">Tabel Inspeksi Bulanan (Bagian 2: Detail Keseluruhan)</p>' .
                '<table class="min-w-full divide-y divide-gray-200 border border-gray-100 text-xs">' .
                ...
                '<tbody class="divide-y divide-gray-100 text-slate-600">' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">DETAIL KESELURUHAN</td></tr>' .
                ...
                '<div class="overflow-x-auto my-4">' .
                '<p class="text-[10px] font-bold text-slate-500 mb-1.5 uppercase">Tabel Inspeksi Quartal (Bagian 1: Operasional & Fungsi)</p>' .
                '<table class="min-w-full divide-y divide-gray-200 border border-gray-100 text-xs">' .
                ...
                '<tbody class="divide-y divide-gray-100 text-slate-600">' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">ROTUNDA</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">KABIN</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">GERAKAN HORIZONTAL</td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>1.</strong> Jalankan Garbarata maju secara total - Slow Down sirkuit akan aktif kira-kira 1 meter sebelum Full Extention dan garbarata akan berhenti sebelum menjangkau Mechanical Stop.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>2.</strong> Jalankan Garbarata mundur secara total - Slow Down sirkuit akan aktif kira-kira 1 meter sebelum Full Retraction dan Garbarata akan berhenti sebelum menjangkau Mechanical Stop.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>3.</strong> Pastikan bel Travel Warning aktif pada saat Garbarata bergerak.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-blue-50/50 text-blue-800 text-[11px] border border-gray-200"><strong>CATATAN:</strong> Semua gerakan harus dilakukan perlahan, jika pengoperasian terasa kasar dan berisik, periksa kerusakan diatas Roller Tracks.</td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>4.</strong> Jalankan boogie ke sisi kanan dan kiri. Roda akan berhenti berputar ketika menyentuh Steer Limit Switch.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">PENGGERAKAN VERTICAL</td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>1.</strong> Naikkan dan turunkan unit. Operasi harus perlahan dan akan berhenti jika mencapai batas atas dan batas bawahnya.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>2.</strong> Kesalahan Vertikal Lift Column pada Limit Switches (Periksa hanya satu limit switch pada satu waktu):<br><span class="pl-4 inline-block">a. Secara manual jalankan limit switch sementara seorang lainnya bekerja menaikkan dan menurunkan Garbarata. Jika Garbarata berlanjut naik atau turun, limit switch rusak dan harus digantikan.</span><br><span class="pl-4 inline-block">b. Ulangi prosedur ini pada Limit Switch yang lain.</span></td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-blue-50/50 text-blue-800 text-[11px] border border-gray-200"><strong>CATATAN:</strong> Semua shim/ganjalan Limit Switch yang bergetar atau dilepaskan atau yang jatuh selama proses apapun harus digantikan sebelum mengencangkan semua limit switch tersebut.</td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">SAMBUNGAN LISTRIK</td></tr>' .
                '<tr><td colspan="2" class="p-2 text-slate-500 font-semibold italic border border-gray-200 bg-slate-50/30">Periksa Control Console operator, Power Panel dan Main Panel listrik:</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">AUTOLEVEL</td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>1.</strong> Periksa semua sekrup yang menahan roda ke limit Switch. Keduanya harus selalu kencang.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>2.</strong> Putar roda dengan tangan pada kedua arah untuk memastikan bebasnya pergerakan ketika difungsikan dan pastikan kembalinya roda ke posisi netral. Hal ini akan bersesuaian dengan Limit Switch.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>3.</strong> Periksa Arm, Arm ini harus bergerak bebas pada kedua arah.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>4.</strong> Putar ketiga posisi Switch ke Auto dan periksa jalannya Autolevel limits terhadap perpanjangan Arm. Setelah kira-kira 3 detik akan muncul Pesan Kesalahan, Buzzer dan Alarm menunjukkan roda Autolevel tidak bersentuhan dengan pesawat. Untuk menstimulasi operasi normal, hentikan Arm diposisi sebelum PX6 dan PX7 aktif.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>5.</strong> Putar dan tahan roda dengan tangan untuk menstimulasi naiknya pesawat. Kira-kira setelah 6 detik, lampu peringatan Autolevel menyala dan alarm bersuara.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td class="p-2 border border-gray-200"><strong>6.</strong> Reset sistem Autolevel dan periksa down travel dengan memutar dan menahan Wheel Counter searah jarum jam. Kira-kira 6 detik, lampu peringatan menyala dan alarm bersuara.</td><td class="p-2 border border-gray-200"></td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-blue-50/50 text-blue-800 text-[11px] border border-gray-200"><strong>CATATAN:</strong> Timer Auto Level diatur oleh Internal Counter Program melalui Programmable Logic Controller. Tekan tombol Emergency saat Auto mode periksa apakah alarm dapat terdengar baik.</td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">PEMERIKSAAN BAN-BAN</td></tr>' .
                ...
                '</tbody></table></div>' .
                '<div class="overflow-x-auto my-6">' .
                '<p class="text-[10px] font-bold text-slate-500 mb-1.5 uppercase">Tabel Inspeksi Quartal (Bagian 2: Struktur, Pelapis Cuaca & Pelumasan Berkala)</p>' .
                '<table class="min-w-full divide-y divide-gray-200 border border-gray-100 text-xs">' .
                '<thead><tr class="bg-gray-50 text-slate-700 font-bold"><th class="p-2 border border-gray-200 text-left w-3/4">POINT-POINT INSPEKSI QUARTAL</th><th class="p-2 border border-gray-200 text-center w-1/4">KETERANGAN</th></tr></thead>' .
                '<tbody class="divide-y divide-gray-100 text-slate-600">' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">KONDISI UMUM DARI EXTERIOR DAN PELAPIS CUACA</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">ROTUNDA (LUMAS! BAGIAN-BAGIAN)</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">TUNNELS</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">VERTICAL COLUMN</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">WHEEL BOOGIE</td></tr>' .
                ...
                '<tr><td colspan="2" class="p-2 bg-blue-50/50 text-blue-800 text-[11px] border border-gray-200"><strong>CATATAN:</strong> Bearings pada roda harus dilumasi juga ketika komponen roda dilepaskan dengan pelumas No. 1.</td></tr>' .
                '<tr><td colspan="2" class="p-2 bg-slate-100 font-bold text-slate-700 uppercase tracking-wider">KABIN (LUMAS!)</td></tr>' .
        ...
        Module::create([
            ...
            'content' => '<p class="text-xs text-slate-600 leading-relaxed mb-4">Manual troubleshooting dibuat sebagai acuan untuk pemeliharaan dan perbaikan yang memadai. Tabel-tabelnya berisi masalah-masalah umum, kemungkinan kasus-kasus yang terjadi dan semua tindakan-tindakan dalam upaya perbaikan yang benar. Manual ini dibuat bagi teknis-teknisi yang memenuhi syarat dalam mengatasi masalah-masalah yang mungkin muncul.</p>' .
                ...
                '</tbody></table></div></div>' .
                '<!-- TROUBLE 2 -->' .
                '<div class="rounded-xl border border-red-200 bg-white p-4 shadow-sm mt-6">' .
                '<div class="bg-red-50 text-red-800 p-3 rounded-lg border border-red-100 mb-4">' .
