...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $module1 = Module::create([
            'course_id' => $course->id,
            'title' => '1. Rotunda (Pangkal Garbarata)',
        ...
        $module2 = Module::create([
            'course_id' => $course->id,
            'title' => '2. Telescopic Tunnel (Terowongan)',
        ...
        $module3 = Module::create([
            'course_id' => $course->id,
            'title' => '3. Cabin & Control Console (Kabin Kemudi)',
        ...
        $module4 = Module::create([
            'course_id' => $course->id,
            'title' => '4. Drive Column & Wheels (Kolom Penggerak)',
        ...
        // 5. Seed Hotspots (koordinat persentase letak komponen pada gambar)
        Hotspot::create([
            'diagram_id' => $diagram->id,
            'target_module_id' => $module1->id,
